...
pub struct IndexerStatusResponse {
    ...
    pub total_indexed_blocks: Option<u64>,
    pub total_indexed_transactions: Option<u64>,
    pub total_write_batches: Option<u64>,
    pub total_put_operations: Option<u64>,
    pub total_delete_operations: Option<u64>,
    pub last_batch_put_operations: Option<u64>,
    pub last_batch_delete_operations: Option<u64>,
